        ...
        <div class="w-full  bg-gray-100 flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
            <div class="flex flex-wrap w-full sm:max-w-md mx-auto pt-48">
                <div class="lg:w-1/2 w-full mb-6 ">
                    <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">本の編集</h1>
            ...
            <form action="{{ route('update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <input id="title" type="text" name="title" value="{{$book->title}}" class="appearance-none rounded-none px-3 py-2 border border-gray-300 text-gray-900 rounded-t-md rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm w-full" />
                </div>
                <div class="mb-4">
                    <label class="block mb-1" for="author">著者</label>
                    <input id="author" type="text" name="author" value="{{$book->author}}" class="appearance-none rounded-none px-3 py-2 border border-gray-300 text-gray-900 rounded-t-md rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm w-full" />
                </div>
                <div class="mb-4">
                    ...
                    <input type="button" onclick="location.href='{{route('show', ['id' => $book->id])}}' " value="戻る" class="text-gray-500 font-semibold py-2 px-8 ">
